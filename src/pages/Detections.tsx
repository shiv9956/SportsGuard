...
const Detections = () => {
  ...
  return (
    <div className="space-y-12 h-screen flex flex-col -mt-8 -mx-8 overflow-hidden">
       ...
       <div className="flex-1 flex min-h-0 border-t border-tactical-border mt-8">
          
          {/* Left: Incident Queue */}
          <div className="w-96 border-r border-tactical-border flex flex-col bg-bg-void overflow-hidden">
          ...
          <div className="flex-1 bg-[#050505] flex flex-col min-w-0">
             <AnimatePresence mode="wait">
               {selected ? (
                 ...
                 >
                    {/* Header Strip */}
                    <div className="p-10 border-b border-tactical-border bg-panel-card flex justify-between items-end backdrop-blur-md">
                       <div>
                          <div className="font-mono text-[9px] text-text-muted uppercase tracking-[0.4em] mb-3">Threat_Dossier: Verified Leak</div>
                          <h2 className="text-6xl font-bold tracking-tighter uppercase leading-none" style={{ fontFamily: "'Arial Narrow', sans-serif" }}>
                       ...
                       <div className="text-right">
                          ...
                          <div className="text-6xl font-bold text-brand-blaze leading-none" style={{ fontFamily: "'Arial Narrow', sans-serif" }}>{selected.similarity}%</div>
                       </div>
                    </div>

                    {/* Comparison Grid */}
                    <div className="flex-1 overflow-y-auto p-10 grid grid-cols-1 xl:grid-cols-2 gap-10 custom-scrollbar">
                       ...
                       <div className="xl:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="p-8 bg-panel-card border border-tactical-border scan-line">
                          ...
                          <div className="p-8 bg-panel-card border border-tactical-border">
                             <div className="font-mono text-[9px] text-text-muted uppercase tracking-[0.3em] mb-4">Infection Metrics</div>
                             <div className="flex justify-between">
                                <div>
                                   <div className="text-4xl font-bold text-white leading-none" style={{ fontFamily: "'Arial Narrow', sans-serif" }}>423</div>
                                ...
                                <div className="text-right">
                                   <div className="text-4xl font-bold text-white leading-none" style={{ fontFamily: "'Arial Narrow', sans-serif" }}>1.8s</div>
                                   <div className="font-mono text-[9px] text-text-muted uppercase mt-2">Detection Latency</div>
                                </div>
                             </div>
                          </div>

                          <div className="p-8 bg-panel-card border border-tactical-border flex flex-col justify-between">
                             <div>
                    ...
                    <div className="p-8 border-t border-tactical-border bg-panel-card flex justify-end gap-6 items-center">
                       ...
                       <button 
                         ...
                         className="font-mono text-xs px-12 py-5 bg-brand-blaze text-white font-bold uppercase tracking-[0.3em] hover:bg-brand-blaze-hover transition-all transform active:scale-95 flex items-center gap-4 disabled:opacity-50 disabled:grayscale shadow-[0_10px_30px_-10px_rgba(255,45,85,0.4)]"
                       >
                 ...
                 <div className="flex-1 flex flex-col items-center justify-center space-y-4 opacity-30 h-full">
                    <Search className="w-24 h-24 text-text-muted" />
                    <div className="text-center font-mono text-xl uppercase tracking-[0.4em] text-text-muted">SELECT_INCIDENT_FOR_ANALYSIS</div>
                 </div>
               )}
             </AnimatePresence>
          </div>
